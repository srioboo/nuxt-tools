 ...
 <section class="main" id="s1">
    ...
    <div id="identificadores">
        ...
        <div>
            ...
            <div>
                <select name="" id="">
                    <option v-for="(storeId, index) in stores" v-bind:key="storeId.name">
                        {{index}}. {{ storeId.name }}
                    </option>
                </select>
        </div>
        <div>
            ...
            <div>
                <select name="" id="">
                    <option v-for="(catalogId, index) in catalogs" v-bind:key="catalogId.cat">
                        {{index}}. {{ catalogId.cat }}
                    </option>
                </select>
            </div>
        ...
        <div>
            <div>CategoryId</div>
            <div>
                <input id="categoryId" name="categoryId" type="number" v-model="categoryId" />
            </div>
        </div>
    </div>

    <div id="entorno" >
        <input type="checkbox" value="stgpre"
